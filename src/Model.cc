...
{
    const QRect iconRect = m_window->iconGeometry().toAlignedRect();
    QRect clipRect = m_window->expandedGeometry().toAlignedRect();
...
{
    const QRect windowRect = m_window->frameGeometry().toAlignedRect();
    const QRect iconRect = m_window->iconGeometry().toAlignedRect();
